...
import { i as isString, a as isNumber$1, b as isNan, g as get, c as isNil, d as isObject, e as isFunction, u as upperFirst, f as uniqBy, s as sortBy, t as throttle, m as min, h as max, j as flatMap, k as isEqual, l as last, n as maxBy, o as minBy, p as isPlainObject, q as isBoolean, r as range, v as every, w as mapValues, x as memoize, y as find, z as some } from "./lodash.mjs";
...
var _excluded$k = ["children"], _excluded2$9 = ["children"];
...
var isSingleChildEqual = function isSingleChildEqual2(nextChild, prevChild) {
  ...
  if (!isNil(nextChild) && !isNil(prevChild)) {
    ...
    var _ref2 = prevChild.props || {}, prevChildren = _ref2.children, prevProps = _objectWithoutProperties$k(_ref2, _excluded2$9);
    if (nextChildren && prevChildren) {
...
var Symbols = function Symbols2(_ref) {
  var _ref$type = _ref.type, type = _ref$type === void 0 ? "circle" : _ref$type, _ref$size = _ref.size, size = _ref$size === void 0 ? 64 : _ref$size, _ref$sizeType = _ref.sizeType, sizeType = _ref$sizeType === void 0 ? "area" : _ref$sizeType, rest = _objectWithoutProperties$h(_ref, _excluded$h);
...
var DefaultLegendContent = /* @__PURE__ */ (function(_PureComponent) {
  function DefaultLegendContent2() {
    _classCallCheck$m(this, DefaultLegendContent2);
    return _callSuper$j(this, DefaultLegendContent2, arguments);
  }
  _inherits$j(DefaultLegendContent2, _PureComponent);
  return _createClass$m(DefaultLegendContent2, [{
    key: "renderIcon",
    value: (
      /**
...
var Legend = /* @__PURE__ */ (function(_PureComponent) {
  function Legend2() {
    var _this;
    _classCallCheck$l(this, Legend2);
  ...
  _inherits$i(Legend2, _PureComponent);
  return _createClass$l(Legend2, [{
...
var TooltipBoundingBox = /* @__PURE__ */ (function(_PureComponent) {
  function TooltipBoundingBox2() {
    var _this;
    _classCallCheck$k(this, TooltipBoundingBox2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
  ...
  _inherits$h(TooltipBoundingBox2, _PureComponent);
  return _createClass$k(TooltipBoundingBox2, [{
    key: "updateBBox",
    value: function updateBBox() {
      if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
        var box = this.wrapperNode.getBoundingClientRect();
...
var Tooltip = /* @__PURE__ */ (function(_PureComponent) {
  function Tooltip2() {
    _classCallCheck$j(this, Tooltip2);
    return _callSuper$g(this, Tooltip2, arguments);
  }
  _inherits$g(Tooltip2, _PureComponent);
  return _createClass$j(Tooltip2, [{
    key: "render",
    value: function render() {
      var _this = this;
...
var DecimalCSS = /* @__PURE__ */ (function() {
  function DecimalCSS2(num, unit) {
    _classCallCheck$i(this, DecimalCSS2);
    this.num = num;
    this.unit = unit;
    this.num = num;
    this.unit = unit;
  ...
  return _createClass$i(DecimalCSS2, [{
    key: "add",
...
var Text = function Text2(_ref5) {
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$f(props, _excluded2$8);
...
var ErrorBar = /* @__PURE__ */ (function(_React$Component) {
  function ErrorBar2() {
    _classCallCheck$h(this, ErrorBar2);
    return _callSuper$f(this, ErrorBar2, arguments);
  }
  _inherits$f(ErrorBar2, _React$Component);
...
function Label(_ref4) {
  var _ref4$offset = _ref4.offset, offset = _ref4$offset === void 0 ? 5 : _ref4$offset, restProps = _objectWithoutProperties$d(_ref4, _excluded$d);
...
var _excluded$c = ["valueAccessor"], _excluded2$7 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
...
function LabelList(_ref) {
  ...
  var data = restProps.data, dataKey = restProps.dataKey, clockWise = restProps.clockWise, id = restProps.id, textBreakAll = restProps.textBreakAll, others = _objectWithoutProperties$c(restProps, _excluded2$7);
  if (!data || !data.length) {
    return null;
  }
  return /* @__PURE__ */ React.createElement(Layer, {
...
var Cross = function Cross2(_ref) {
  var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$a(_ref, _excluded$a);
...
var _excluded$9 = ["cx", "cy", "angle", "ticks", "axisLine"], _excluded2$6 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
...
var PolarRadiusAxis = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$g(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread$l(_objectSpread$l(_objectSpread$l({}, filterProps(others, false)), {}, {
        fill: "none"
      ...
      return /* @__PURE__ */ React.createElement("line", _extends$i({
    ...
    value: function renderTicks() {
      var _this = this;
      var _this$props4 = this.props, ticks = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties$9(_this$props4, _excluded2$6);
      var textAnchor = this.getTickTextAnchor();
      var axisProps = filterProps(others, false);
      var customTickProps = filterProps(tick, false);
      var items = ticks.map(function(entry, i) {
        var coord = _this.getTickValueCoord(entry);
        var tickProps = _objectSpread$l(_objectSpread$l(_objectSpread$l(_objectSpread$l({
          textAnchor,
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ React.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ React.createElement(Text, _extends$i({}, props, {
...
var PolarAngleAxis = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$f(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread$k(_objectSpread$k({}, filterProps(this.props, false)), {}, {
        fill: "none"
      }, filterProps(axisLine, false));
      if (axisLineType === "circle") {
        return /* @__PURE__ */ React.createElement(Dot, _extends$h({
      ...
      return /* @__PURE__ */ React.createElement(Polygon, _extends$h({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks.map(function(entry, i) {
        ...
        var tickProps = _objectSpread$k(_objectSpread$k(_objectSpread$k({
          textAnchor
        }, axisProps), {}, {
          stroke: "none",
          fill: stroke
        ...
        return /* @__PURE__ */ React.createElement(Layer, _extends$h({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ React.createElement("line", _extends$h({
...
var Trapezoid = function Trapezoid2(props) {
  var trapezoidProps = _objectSpread$j(_objectSpread$j({}, defaultProps$1), props);
  var pathRef = reactExports.useRef();
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ React.createElement("g", null, /* @__PURE__ */ React.createElement("path", _extends$g({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ React.createElement(Animate, {
    ...
    return /* @__PURE__ */ React.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ React.createElement("path", _extends$g({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function Shape(_ref2) {
  ...
  var shape;
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    shape = /* @__PURE__ */ reactExports.cloneElement(option, _objectSpread$i(_objectSpread$i({}, props), getPropsFromShapeOption(option)));
  } else if (isFunction(option)) {
    shape = option(props);
  ...
  return _createClass$e(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ React.createElement(Shape, _extends$f({
      ...
      return /* @__PURE__ */ React.createElement(Animate, {
        ...
        sectors.forEach(function(entry, index) {
          ...
          if (prev) {
            ...
            var latest = _objectSpread$h(_objectSpread$h({}, entry), {}, {
            ...
            var _latest = _objectSpread$h(_objectSpread$h({}, entry), {}, {
              startAngle: curAngle + paddingAngle,
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ React.createElement(Curve, _extends$f({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ React.createElement(Text, _extends$f({}, props, {
...
_defineProperty$k(Pie, "getRealPieData", function(itemProps) {
  ...
  if (data && data.length) {
    return data.map(function(entry, index) {
      return _objectSpread$h(_objectSpread$h(_objectSpread$h({
        payload: entry
  ...
  if (cells && cells.length) {
    return cells.map(function(cell) {
      return _objectSpread$h(_objectSpread$h({}, presentationProps), cell.props);
    });
  }
  return [];
});
...
_defineProperty$k(Pie, "getComposedData", function(_ref4) {
  ...
  var itemProps = item.type.defaultProps !== void 0 ? _objectSpread$h(_objectSpread$h({}, item.type.defaultProps), item.props) : item.props;
  ...
  if (sum > 0) {
    ...
    sectors = pieData.map(function(entry, i) {
      ...
      prev = _objectSpread$h(_objectSpread$h(_objectSpread$h({
        percent,
        cornerRadius,
        name,
        tooltipPayload,
  ...
  return _objectSpread$h(_objectSpread$h({}, coordinate), {}, {
    sectors,
    data: pieData
  });
});
...
function typeGuardSectorProps(option, props) {
  ...
  return _objectSpread$g(_objectSpread$g(_objectSpread$g({}, props), option), {}, {
    cx,
    cy
  });
}
function RadialBarSector(props) {
  return /* @__PURE__ */ React.createElement(Shape, _extends$e({
    shapeType: "sector",
    propTransformer: typeGuardSectorProps
  }, props));
}
var _excluded$7 = ["shape", "activeShape", "activeIndex", "cornerRadius"], _excluded2$5 = ["value", "background"];
function _typeof$i(o) {
  "@babel/helpers - typeof";
  return _typeof$i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o2) {
    return typeof o2;
...
var RadialBar = /* @__PURE__ */ (function(_PureComponent) {
  function RadialBar2() {
    var _this;
    _classCallCheck$d(this, RadialBar2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper$b(this, RadialBar2, [].concat(args));
  ...
  _inherits$b(RadialBar2, _PureComponent);
  return _createClass$d(RadialBar2, [{
    key: "getDeltaAngle",
    ...
    value: function renderSectorsStatically(sectors) {
      var _this2 = this;
      var _this$props2 = this.props, shape = _this$props2.shape, activeShape = _this$props2.activeShape, activeIndex = _this$props2.activeIndex, cornerRadius = _this$props2.cornerRadius, others = _objectWithoutProperties$7(_this$props2, _excluded$7);
      var baseProps = filterProps(others, false);
      return sectors.map(function(entry, i) {
        var isActive = i === activeIndex;
        var props = _objectSpread$f(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, baseProps), {}, {
        ...
        return /* @__PURE__ */ React.createElement(RadialBarSector, _extends$d({}, props, {
          key: "sector-".concat(i)
        }));
      });
    }
    ...
    value: function renderBackground(sectors) {
      ...
      return sectors.map(function(entry, i) {
        entry.value;
        var background = entry.background, rest = _objectWithoutProperties$7(entry, _excluded2$5);
        if (!background) {
          return null;
        }
        var props = _objectSpread$f(_objectSpread$f(_objectSpread$f(_objectSpread$f(_objectSpread$f({
          cornerRadius: parseCornerRadius(cornerRadius)
        }, rest), {}, {
          fill: "#eee"
    ...
    value: function render() {
      ...
      }, this.renderSectors()), (!isAnimationActive || isAnimationFinished) && LabelList.renderCallByParent(_objectSpread$f({}, this.props), data));
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(nextProps, prevState) {
...
_defineProperty$i(RadialBar, "displayName", "RadialBar");
_defineProperty$i(RadialBar, "defaultProps", {
  angleAxisId: 0,
  radiusAxisId: 0,
  minPointSize: 0,
  hide: false,
...
_defineProperty$i(RadialBar, "getComposedData", function(_ref2) {
  ...
  var sectors = displayedData.map(function(entry, index) {
    ...
    return _objectSpread$f(_objectSpread$f(_objectSpread$f(_objectSpread$f({}, entry), backgroundSector), {}, {
      payload: entry,
